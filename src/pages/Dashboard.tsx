...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen pb-24 md:pb-8">
      {/* Navbar */}
      <nav ref={headerRef} className="sticky top-0 z-50 bg-card/80 backdrop-blur-xl border-b border-border/50 shadow-sm rounded-b-2xl">
      ...
      <div className="max-w-5xl mx-auto px-4 md:px-12 space-y-8">
        {/* Stats & Progress Section */}
        <section>
          {/* Main Progress Card */}
          <div ref={progressCardRef} className="rounded-2xl md:rounded-3xl bg-gradient-to-br from-card via-card to-muted/20 p-4 sm:p-6 md:p-8 shadow-lg md:shadow-xl border border-border/30 overflow-hidden relative">
            ...
            <div className="absolute -bottom-16 -right-16 w-44 h-44 sm:w-56 sm:h-56 md:w-64 md:h-64 rounded-full blur-3xl animate-pulse-slower" 
                 style={{ background: 'radial-gradient(circle, rgba(59, 130, 246, 0.3), transparent)', zIndex: 0 }} />
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-4 md:gap-6 relative z-10">
              ...
              <div 
                ...
                className="group relative rounded-xl md:rounded-2xl bg-success/5 hover:bg-success/10 p-3 sm:p-4 md:p-6 transition-all duration-300 cursor-pointer"
              >
                ...
                <div className="text-[10px] sm:text-xs md:text-sm text-success/80 font-semibold uppercase tracking-wide">Completed</div>
                <div className="mt-1 sm:mt-2 text-[9px] sm:text-xs text-muted-foreground hidden sm:block">Tasks done today</div>
              </div>
              ...
              <div 
                ...
                className="group relative rounded-xl md:rounded-2xl bg-orange-500/5 hover:bg-orange-500/10 p-3 sm:p-4 md:p-6 transition-all duration-300 cursor-pointer"
              >
                ...
                <div className="text-[10px] sm:text-xs md:text-sm text-orange-600/80 font-semibold uppercase tracking-wide">Due Today</div>
                <div className="mt-1 sm:mt-2 text-[9px] sm:text-xs text-muted-foreground hidden sm:block">Needs attention</div>
              </div>
              ...
              <div 
                ...
                className="group relative rounded-xl md:rounded-2xl bg-blue-500/5 hover:bg-blue-500/10 p-3 sm:p-4 md:p-6 transition-all duration-300 cursor-pointer"
              >
                ...
                <div className="text-[10px] sm:text-xs md:text-sm text-blue-600/80 font-semibold uppercase tracking-wide">Tomorrow</div>
                <div className="mt-1 sm:mt-2 text-[9px] sm:text-xs text-muted-foreground hidden sm:block">Can wait</div>
              </div>
            </div>

            {/* Streak Banner */}
            <div ref={streakRef} className="mt-4 sm:mt-6 rounded-xl md:rounded-2xl bg-gradient-to-r from-primary/25 via-primary/15 to-primary/10 p-4 sm:p-5 md:p-6 relative overflow-hidden group hover:shadow-lg hover:shadow-primary/10 transition-all duration-300 z-10">
        ...
        <div>
          <section>
            ...
            <div className="grid gap-4">
              {habitSections.map((habit, index) => {
                ...
                return (
                  ...
                  >
                    <div className={cn(
                      "task-card-inner rounded-3xl bg-card shadow-md transition-colors duration-300",
                      colors.bg
                    )}>
                      {/* Task Header */}
                      <div 
                      ...
                      >
                        <div className="flex items-start gap-3 sm:gap-4">
                          <div className="task-number flex items-center justify-center h-8 w-8 sm:h-10 sm:w-10 rounded-full bg-primary/10 text-primary font-bold text-xs sm:text-sm flex-shrink-0">
                            {index + 1}
                          </div>
                          <div className={cn(
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2 mb-1">
                              ...
                              <span className={cn(
                                "task-badge text-[10px] sm:text-xs font-medium px-2 py-0.5 sm:py-1 rounded-full inline-block w-fit",
                                colors.badge
                              )}>
                                {colors.badgeText}
                              </span>
                            ...
                            <div className="space-y-4">
                              ...
                              {habit.type === "numeric" && habit.title === "Sleep" && (
                                <div className="grid grid-cols-2 gap-4">
                                  <div>
                                    <Label>Hours</Label>
                                    <Input type="number" placeholder="8" className="rounded-xl mt-1" />
                                  </div>
                                  <div>
                                    <Label>Minutes</Label>
                                    <Input type="number" placeholder="30" className="rounded-xl mt-1" />
                                  </div>
                                </div>
                              )}
                              ...
                              {habit.type === "descriptive_numeric" && (
                                <>
                                  <div>
                                    ...
                                    <Input type="number" step="0.1" placeholder="70.5" className="rounded-xl mt-1" />
                                  </div>
                                  <div>
                              ...
                              {habit.type === "numeric_list" && (
                                <>
                                  <div>
                                    ...
                                    <Input type="number" placeholder="2000" className="rounded-xl mt-1" />
                                  </div>
                                  <div>
                                    <Label>Breakfast</Label>
                                    <Input placeholder="Oats with milk, fruits" className="rounded-xl mt-1" />
                                  </div>
                                  <div>
                                    <Label>Lunch</Label>
                                    <Input placeholder="Rice, chicken curry, salad" className="rounded-xl mt-1" />
                                  </div>
                                  <div>
                                    <Label>Dinner</Label>
                                    <Input placeholder="Grilled fish, vegetables" className="rounded-xl mt-1" />
                                  </div>
                                </>
                              )}
                              ...
                              {habit.type === "contact_list" && (
                                <div>
                                  ...
                                  {(taskPoints[index] || ['']).map((_, idx) => (
                                    <div key={idx}>
                                      <div className="flex gap-2 mt-2">
                                        <Input placeholder="Name" className="rounded-xl flex-1" />
                                        <Input placeholder="Designation" className="rounded-xl flex-1" />
                                        {(taskPoints[index] || ['']).length > 1 && (
                                          <Button
                                            type="button"
                                            size="icon"
                                ...
                                <>
                                  ...
                                  <div>
                                    ...
                                    <div className="relative mt-1">
                                      ...
                                      <Input placeholder="https://..." className="rounded-xl pl-10" />
                                    </div>
                                  </div>
                                </>
                              )}
                              ...
                              {habit.type === "numeric" && habit.title === "Prayer/Meditation" && (
                                <div>
                                  <Label>Minutes</Label>
                                  <Input type="number" placeholder="15" className="rounded-xl mt-1" />
                                </div>
                              )}
            ...
            <div className="mt-8 mb-16 rounded-3xl  bg-gradient-to-br from-primary/20 to-primary/10 p-6 md:p-8 shadow-lg">
              ...
              <Textarea 
                ...
                className="rounded-xl min-h-[120px] bg-card/50 border-primary/10"
              />
              <Button 
